...
class SubscribeYoutubeWidget extends StatefulWidget {
  final TaskModel task;
  final String taskStatus;

  const SubscribeYoutubeWidget({
    super.key,
    required this.task,
  ...
  @override
  State<SubscribeYoutubeWidget> createState() => _SubscribeYoutubeWidgetState();
}

class _SubscribeYoutubeWidgetState extends State<SubscribeYoutubeWidget> {
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const Spacer(),
            GradientFollowButton(label: 'Visit',
              onPressed: () async {
