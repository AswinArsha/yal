...
class AccountFollowingTaskWidget extends StatefulWidget {
  final TaskModel task;
  final String taskStatus;

  const AccountFollowingTaskWidget({
    super.key,
    required this.task,
  ...
  @override
  State<AccountFollowingTaskWidget> createState() =>
      _AccountFollowingTaskWidgetState();
}

class _AccountFollowingTaskWidgetState
    extends State<AccountFollowingTaskWidget> {
    ...
    return Column(
      ...
      children: [
        ...
        AppTextFormField(
          ...
          hintText: 'Enter your X username',
        ...
        Row(children: [
          ...
          Expanded(
            child: Text(
              "Make sure you click on 'Done' once you followed and retweeted",
              style: GoogleFonts.poppins(
                textStyle: TextStyle(
                  color: AppColors.baseWhite.withOpacity(0.6),
                  fontSize: 10.sp,
