...
class VisitWebsiteWidget extends StatefulWidget {
  final TaskModel task;
  final String taskStatus;

  const VisitWebsiteWidget({
    super.key,
    required this.task,
  ...
  @override
  State<VisitWebsiteWidget> createState() => _VisitWebsiteWidgetState();
}

class _VisitWebsiteWidgetState extends State<VisitWebsiteWidget> {
    ...
    return Column(
      ...
      children: [
        ...
        Row(children: [
          ...
          Expanded(
            child: Text(
              "Make sure you click on 'Done' once you've vistited'",
              style: GoogleFonts.poppins(
                textStyle: TextStyle(
                  color: AppColors.baseWhite.withOpacity(0.6),
                  fontSize: 10.sp,
