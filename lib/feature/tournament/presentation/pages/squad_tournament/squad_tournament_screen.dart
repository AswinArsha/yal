...
import 'package:yalgamers/feature/tournament/presentation/pages/squad_tournament/squad_register_screen.dart';
...
import 'package:yalgamers/feature/tournament/presentation/widgets/squad_tournament_widgets/squad_reward_widget.dart';
import 'package:yalgamers/feature/tournament/presentation/widgets/squad_tournament_widgets/teams_widget.dart';
import 'package:yalgamers/feature/tournament/presentation/widgets/stream_widget.dart';

class SquadTournamentScreen extends StatefulWidget {
  const SquadTournamentScreen({super.key});

  @override
  State<SquadTournamentScreen> createState() => _SquadTournamentScreenState();
}

class _SquadTournamentScreenState extends State<SquadTournamentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'PUBG Mobile Mena Su...'),
      body: Stack(
        children: [
          // Scrollable content
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          if (isSelected) ...[
            Image.asset(
              'assets/icons/3-user-icon.png', // ✅ Replace with your actual image path
              width: 16,
              height: 16,
            ),
          ...
          if (isStatus) ...[
            Image.asset(
              'assets/icons/registration-squad-icon.png', // ✅ Replace with your actual image path
              width: 16,
              height: 16,
            ),
            const SizedBox(width: 4),
          ...
          Text(
            text,
            style: AppTextStyles.small(
              color: isSelected ? Color(0xFFBC5AD7) : Color(0xFF1FD031),
              size: 12,
              fontWeight: FontWeight.w500,
            ),
          ),
